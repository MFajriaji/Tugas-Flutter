...
import 'package:apkbacaansholat/model/model_niat.dart';
...
class _NiatSholatState extends State<NiatSholat> {
  // Buat instance dari AudioPlayer
  ...
  @override
  void dispose() {
    _audioPlayer.dispose(); // Pastikan untuk menghentikan audio ketika widget dihancurkan
    super.dispose();
  }
                    ...
                    if (data.hasError) {
                      ...
                      return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            // Tambahkan jalur audio untuk setiap item
                            String audioPath = 'assets/audio/${items[index].id}.mp3';
